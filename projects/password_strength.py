...
while True:
    ...
    for i in password:
        if i.isupper():
            ...
            outputs.extend("At least one uppercase letter")
    ...
    for i in password:
        if i.islower():
            ...
            outputs.extend("at least one lowercase letter")
    ...
    for i in password:
        if i.isalnum():
            ...
            outputs.extend("At least one number")
    # LOOP FIVE
    ...
    if spec_chars in password:
        ...
        outputs.extend("At least one special character")
